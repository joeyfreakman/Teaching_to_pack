    ...
    def __getitem__(self, index):
        ...
        if self.transformations is None:
            ...
            self.transformations = [
                ...
                transforms.Resize(original_size,antialias=True)# transforms.Resize((240,320), antialias=True),
                ]
...
if __name__ == "__main__":
    ...
    stats = RawImageDataset.get_norm_stats([args.dataset_dir], [num_episodes])
